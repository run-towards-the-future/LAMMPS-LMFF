...
class PairLMFF : public Pair {
 public:
  ...
  void computeLMFFsimple(pair_lmff_param_t *pm);	//added by ping;
 ...
 protected:
  ...
  virtual void repulsive(Param *, double, double &, int, double &);
	...
	void ters_Att(Param *param, double prefactor,double rij, double rijinv, 
								double rik, double rikinv,double *delrij, double *delrik,
								double *fi, double *fj, double *fk);
	void ters_force_zeta(Param *param, double r, double zeta_ij,
                      double &fforce, double &prefactor, int eflag, double &eng);
	double ters_zeta(Param *param, double rij, double rik,
											double *delrij, double *delrik);
	void calc_normal(int, int, double vet[][3], double normal[], 
									double dnormal[][3][3], double dnormdri[][3]);


inline void ev_tally_simple(int i, int j, int nlocal, int newton_pair,
...
inline void ev_tally_buffer_simple(int i, int j, double *ei, double *vi, 
													double *ej, double *vj, 
...
inline void ev_tally_xyz_simple(int i, int j, int nlocal, int newton_pair,
                        double evdwl, double ecoul,
                        double fx, double fy, double fz,
                        double delx, double dely, double delz, 
												double *eng_vdwl, double *eng_coul, double *virial)
