...
{
	GPTLstart("CommBrick: reverse comm");
  int n;
  MPI_Request request;
  AtomVec *avec = atom->avec;
  double **f = atom->f;
  ...
  for (int iswap = nswap-1; iswap >= 0; iswap--) {
	...
	GPTLstop("CommBrick: reverse comm");
}
...
{
	GPTLstart("reverse comm fix variable");
  ...
  for (iswap = nswap-1; iswap >= 0; iswap--) {
	...
	GPTLstop("reverse comm fix variable");
}
