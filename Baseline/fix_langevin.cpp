...
{
	GPTLstart("Langevin: compute_target");
  int *mask = atom->mask;
  int nlocal = atom->nlocal;
  ...
  if (tstyle == CONSTANT) {
	...
	GPTLstop("Langevin: compute_target");
}
...
{
	GPTLstart("Langevin: omega_thermostat");
  double gamma1,gamma2;
  ...
  for (int i = 0; i < nlocal; i++) {
	...
	GPTLstop("Langevin: omega_thermostat");
}
...
{
	GPTLstart("Langevin: angmom_thermostat");
  double gamma1,gamma2;
  ...
  for (int i = 0; i < nlocal; i++) {
	...
	GPTLstop("Langevin: angmom_thermostat");
}
