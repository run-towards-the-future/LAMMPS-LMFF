...
class Pair : protected Pointers {
 ...
 protected:
  ...
  inline int sbmask(int j) const {
	...
	////for ILP potential;	
	//
  //Param_ilp_str *ilp_params;       // parameter set for I-J interactions
  //int **ilp_elem2param;    // mapping from element pairs to parameters
  //int *ilp_map;            // mapping from atom types to elements
  //int ilp_nelements;       // # of unique elements
  //int ilp_nparams;         // # of stored parameter sets
	//int ilp_tap_flag;
  //double **ilp_cutILPsq;    // mapping the cutoff from element pairs to parameters
